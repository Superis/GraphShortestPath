...
##Bidirectional Search Συντομοτερων Μονοπατιών

H αναζήτηση διαφοροποιείται ελαφρώς ανάμεσα στον στατικό και τον δυναμικό γράφο.
Στον στατικό ελέγχουμε αν οι 2 κόμβοι ανήκουν στο ίδιο strongly connected component.Αν ναι πραγματοποιούμε μια αναζήτηση στην οποία φροντίζουμε στο Node::StaticShortestPath να ανοίγουμε μόνο όσους κόμβους ανήκουν σε αυτό το component.Διαφορετικά ρωτάμε το ευρετήριο Grail. Αν αυτό μας απαντήσει no επιστρέφουμε σίγουρα -1,διαφορετικά σε περίπτωση maybe τρέχουμε μια αναζήτηση στον γράφο.
 Έχουμε την έννοια του level η οποία μας δείχνει το επίπεδο στο οποίο βρισκόμαστε κάθε φορά στην αναζήτηση και για τις 2 κατευθύνσεις. Οι ενδείξεις src_visited και dest_visited(αριθμού όμως όσα τα threads στο 3ο part) στο ΙndexNode μας βοηθούν να δούμε αν έχουμε επισκεφτεί τον κόμβο στην αναζήτηση της κάθε κατεύθυνσης. Χρησιμοποιούμε επίσης όμως και μια ουρά ώστε να μη χρειάζεται σε κάθε νέο επίπεδο να ψάχνουμε όλους τους κόμβους και την ένδειξη τους για να μάθουμε αν θα τους ανοίξουμε αλλά να ανοίγουμε μόνο όσους βρίσκονται στην ουρά. Επίσης οι παραπάνω ενδείξεις μας βοηθούν αντίστοιχα στον έλεγχο του αν έχουμε επισκεφτεί τον εκάστοτε κόμβο να μην ψάχνουμε μια ολόκληρη ουρά.
